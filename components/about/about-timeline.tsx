...
const milestones = [
  ...
  { year: "2021", text: "Akdeniz geneli teknik servis ve saha desteği yapılandırıldı; bölgesel müdahale süreleri iyileştirildi" },
  ...
  {
    year: "2026",
    text: "Dijital servis randevusu ve uzaktan teşhis altyapısı devreye alındı; Akdeniz geneli yedek parça erişimi güçlendirildi",
  },
]

/**
 * Hakkımızda sayfası kilometre taşları bölümü — kuruluş 2018, makine eşikleri ve Akdeniz servis odağı.
 */
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mt-4 text-sm leading-relaxed">
            2018&apos;de çıktığımız yolda bininci, ikinci ve üçüncü binlik kurulumları tamamladık; Akdeniz genelinde servis
