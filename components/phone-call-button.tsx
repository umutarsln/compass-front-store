...
export function PhoneCallButton() {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 flex max-w-[calc(100vw-3rem)] items-stretch overflow-hidden rounded-full bg-[hsl(217,82%,52%)] text-white shadow-elevated ring-2 ring-white/25 transition-[box-shadow,transform] duration-300 hover:shadow-[0_8px_30px_rgba(37,99,235,0.45)] hover:ring-white/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white active:scale-[0.98] motion-safe:hover:-translate-y-0.5"
