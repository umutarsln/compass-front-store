...
/**
 * Sol altta sabit `tel:` FAB: mobilde “Bizi arayın” her zaman görünür;
 * md+ ekranlarda ikon önde, hover/odakta metin sağa doğru genişler.
 */
export function PhoneCallButton() {
  return (
    ...
    >
      ...
      <span
        className="flex items-center pl-1 pr-4 text-sm font-semibold tracking-tight whitespace-nowrap opacity-100 transition-[max-width,opacity,padding] duration-300 ease-out md:max-w-0 md:overflow-hidden md:opacity-0 md:pl-0 md:pr-0 md:group-hover:max-w-[200px] md:group-hover:opacity-100 md:group-hover:pl-1 md:group-hover:pr-4 md:group-focus-visible:max-w-[200px] md:group-focus-visible:opacity-100 md:group-focus-visible:pl-1 md:group-focus-visible:pr-4"
        aria-hidden
      >
        Bizi arayın
      </span>
